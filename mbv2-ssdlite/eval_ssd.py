...
from vision.ssd.ssd_lite_prune import create_mobilenetv2_ssd_lite_prune, create_mobilenetv2_ssd_lite_predictor_prune
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        net = create_mobilenetv2_ssd_lite_prune(len(class_names),
                width_mult=args.mb2_width_mult, is_test=True, cfg=invert_cfg,
    ...
    if args.net == 'vgg16-ssd':
        ...
        predictor = create_mobilenetv2_ssd_lite_predictor_prune(net, nms_method=args.nms_method, device=DEVICE)
    else:
        logging.fatal("The net type is wrong. It should be one of vgg16-ssd, mb1-ssd and mb1-ssd-lite.")
        parser.print_help(sys.stderr)
        sys.exit(1)
